...
## [1.1.8] - 2025-08-03
### Added
- **Prompt Tracking System** - automatické sledování všech AI promptů
- Nový příkaz `SpecStoryAutoSave: Export Prompt History to File`
- Export historie promptů do `prompts-history.txt` s timestampy
- Každý prompt se loguje ve zkrácené verzi (první 50 znaků)
- Maximum 1000 záznamů v historii (automatická rotace)

### Fixed  
- Opraveno debugování prázdných notifikací - přidána kontrola délky a obsahu zprávy
- Reset counter nyní také vymaže historii promptů

### Updated
- AI instructions rozšířeny o pozorování a zjištění o fungování detekce
- Zdokumentován Prompt Tracking System v .github/ai-instructions.md
